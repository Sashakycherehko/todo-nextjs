      ...
      {/* <div className="modal-Add-task">
        <div className="modal">
          ...
          <div className="modal-options">
            <div className="options-selection_date">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
              ...
              <span>Today</span>
              <button className="options-selection-destroyThisDate">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
            ...
            <div className="options-selection-priority"></div>
            <div className="options-selection-reminders"></div>
          ...
          <div className="modal-selection"></div>
        </div>
      </div> */}
    </>
  );
